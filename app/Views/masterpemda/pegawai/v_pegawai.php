...
<div class="section-header">
    ...
    <div class="section-header-button">
        <form action="<?= htmlentities(base_url('master/f_pegawaip')); ?>" method="post">
            <?= csrf_field() ;?>
                        ...
                        <table style="font-size: 12px;" class="table-striped table-sm table table-hover" id="table-1">
                            <thead style="background-color: rgba(90, 69, 250, 0.867); color: yellow;">
                                <tr>
                                    ...
                                    <!-- <th>JABATAN</th> -->
                                    <th rowspan="1" colspan="1" style="width: 5%;">Aksi</th>
                                    <!-- <th rowspan="1" colspan="1" style="width: 2%;"></th> -->
                                    <th rowspan="1" colspan="1" style="width: 2%;"></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td>
                                        <form action="</?= base_url('/master/f_detailpegawaip/' . $p->id); ?>" method="post">
                                            <button style="cursor: pointer;" class="btn btn-sm btn-light" data-toggle="tooltip" title="DETAIL PEGAWAI : <?= htmlentities($p->nama_pegawai); ?>">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                        </form>
                                    </td> -->
                                    <td class="text-right">
                                        <form action="<?= htmlentities(base_url('/master/f_editpegawaip/' . $p->id)); ?>" method="post">
                                            <?= csrf_field() ;?>
                            ...
                            <tfoot>
                                <tr>
                                    <th rowspan="1" colspan="1" style="width: 2%;" class="text-center">No</th>
                                    <th rowspan="1" colspan="1" style="width: 13%;">Nik</th>
                                    <th rowspan="1" colspan="1">Nama Pegawai</th>
                                    <!-- <th>JABATAN</th> -->
                                    <th rowspan="1" colspan="1" style="width: 5%;">Aksi</th>
                                    <!-- <th rowspan="1" colspan="1" style="width: 2%;"></th> -->
