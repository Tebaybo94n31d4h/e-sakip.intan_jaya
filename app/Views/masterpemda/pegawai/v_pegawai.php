...
<div class="section-header">
    ...
    <div class="section-header-button">
        <form action="<?= base_url('master/f_pegawaip'); ?>" method="post">
                                ...
                                <tr>
                                    ...
                                    <!-- <td>
                                        <form action="</?= base_url('/master/f_detailpegawaip/' . $p->id); ?>" method="post">
                                            <button style="cursor: pointer;" class="btn btn-sm btn-light" data-toggle="tooltip" title="DETAIL PEGAWAI : <?= $p->nama_pegawai; ?>">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                        </form>
                                    </td> -->
                                    <td class="text-right">
                                        <form action="<?= base_url('/master/f_editpegawaip/' . $p->id); ?>" method="post">
