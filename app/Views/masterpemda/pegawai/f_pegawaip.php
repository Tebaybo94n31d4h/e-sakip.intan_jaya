...
<div class="section-body">
    <div class="card">
        <form action="<?= htmlentities(base_url('master/proccesstambahpegawaip')); ?>" method="POST" id="tab-content-1">
                                ...
                                <div class="row">
                                    ...
                                    <p class="card-title text-primary" style="font-size: 16px; font-weight: bold;">Biodata</p>
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="nip" id="nip" type="text" class="form-control <?= ($validation->hasError('nip')) ? 'is-invalid' : ''; ?>" placeholder="Masukkan nip">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="nik" id="nik" type="text" class="form-control <?= ($validation->hasError('nik')) ? 'is-invalid' : ''; ?>" placeholder="Masukkan nik">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="nama_pegawai" id="nama_pegawai" type="text" class="form-control <?= ($validation->hasError('nama_pegawai')) ? 'is-invalid' : ''; ?>" placeholder="Masukkan nama lengkap">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="no_hp" id="no_hp" type="text" class="form-control <?= ($validation->hasError('no_hp')) ? 'is-invalid' : ''; ?>" placeholder="0852xxxxxxxx">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="email" id="email" type="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" placeholder="jhon@gmail.com">
                                            <div class="invalid-feedback">
