...
<div class="section-header">
    ...
    <div class="section-header-back">
        <form action="<?= base_url('rpjmd/tujuanp'); ?>" method="post">
...
<div class="section-body">
    <div class="card">
        <form action="<?= base_url('rpjmd/proccesstambahtujuanp'); ?>" method="POST" id="tab-content-1">
                ...
                <div class="mb-3 card">
                    <div class="card-body table-responsive">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control <?= ($validation->hasError('ms_id')) ? 'is-invalid' : ''; ?>" name="ms_id" id="ms_id">
                                    ...
                                    <?php foreach($selectmisi as $sm) : ?>
                                        <option value="<?= $sm->id; ?>"><?= $sm->no_urut; ?> <?= $sm->misi; ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                            <textarea class="summernote-simple <?= ($validation->hasError('tj')) ? 'is-invalid' : ''; ?>""></textarea>
                                <div class="invalid-feedback">
            ...
            <div class="card-footer text-right">
                ...
                <a href="<?= base_url('rpjmd/tujuanp'); ?>" class="mt-1 btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
