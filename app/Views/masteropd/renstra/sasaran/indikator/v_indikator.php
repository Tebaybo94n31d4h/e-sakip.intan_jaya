...
<div class="section-header">
    ...
    <div class="section-header-button">
        <form action="<?= htmlentities(base_url('renstra/f_indikatorsasaranopdo')); ?>" method="post">
            <?= csrf_field() ;?>
...
<div class="section-body">
    <h2 class="section-title">Data Indikator Sasaran</h2>
    <p class="section-lead">
        Informasi tentang data indikator sasaran dihalaman ini.
    </p>
                ...
                <table style="font-size: 12px;" class="table table-sm table-striped table-hover" id="table-1">
                    <thead style="background-color: rgba(90, 69, 250, 0.867); color: yellow;">
                        <tr>
                            ...
                            <th colspan="1" rowspan="1">Sasaran OPD</th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($procedure as $p) : ?>
                            <tr>
                                ...
                                <td><?= htmlentities($p->sasaran_opd_id); ?></td>
                                <td><?= htmlentities($p->indikator_sasaran_opd); ?></td>
                                <!-- <td>
                                    <a class="btn btn-light" href="</?= base_url('renstra/targetindikatorsasaran/' . $p->id); ?>"> <i class="fas fa-folder"></i> Target Indikator Sasaran</a>
                                </td> -->
                            </tr>
                            <?php $no++; ?>
                        <?php endforeach; ?>
