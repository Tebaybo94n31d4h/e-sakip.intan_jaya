...
<div class="section-header">
    ...
    <div class="section-header-back">
        <form action="<?= base_url('renstra/indikatorsasaranopd'); ?>" method="post">
...
<div class="section-body">
    <div class="card">
        <form action="<?= base_url('renstra/proccesstambahsasaranopdo'); ?>" method="POST" id="tab-content-1">
            ...
            <div class="col-sm-8 m-auto">
                <div class="mb-3 card">
                    <div class="card-body table-responsive">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-3"><label for="indktr_ssrn_opd">Indikator Sasaran Opd <strong class="text-danger"><sup>*</sup></strong> </label></div>
                            <div class="col sm-9">
                                <textarea name="indktr_ssrn_opd" id="indktr_ssrn_opd" rows="5" class="form-control <?= ($validation->hasError('indktr_ssrn_opd')) ? 'is-invalid' : ''; ?>"></textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-3"><label for="indktr_ssrn_opd">Tercapai <strong class="text-danger"><sup>*</sup></strong> </label></div>
