...
<div class="section-header">
    ...
    <div class="section-header-back">
        <form action="<?= htmlentities(base_url('renstra/sasarano')); ?>" method="post">
            <?= csrf_field() ;?>
...
<div class="section-body">
    <div class="card">
        <form action="<?= htmlentities(base_url('renstra/proccesstambahsasarano')); ?>" method="POST" id="tab-content-1">
            ...
            <div class="col-12 col-sm-12 col-lg-8 m-auto">
                <div class="mb-3 card">
                    <div class="card-body table-responsive">
                        <?= csrf_field(); ?>
                        <div class="row mb-3">
                            <div class="col-sm-3"><label for="tjn_opd_id">Tujuan <strong class="text-danger"><sup>*</sup></strong> </label></div>
                            <div class="col-sm-9">
                                <select class="form-control <?= ($validation->hasError('tjn_opd_id')) ? 'is-invalid' : ''; ?>" name="tjn_opd_id" id="tjn_opd_id">
                                    ...
                                    <?php foreach ($selecttujuan as $st) : ?>
                                        <option value="<?= htmlentities($st->id); ?>"><?= htmlentities($st->tujuan_opd); ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col sm-9">
                                <textarea name="ssrn_opd" id="ssrn_opd" class="form-control <?= ($validation->hasError('ssrn_opd')) ? 'is-invalid' : ''; ?>"></textarea>
                                <div class="invalid-feedback">
            ...
            <div class="card-footer text-right">
                ...
                <a href="<?= htmlentities(base_url('renstra/sasarano')); ?>" class="mt-1 btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
