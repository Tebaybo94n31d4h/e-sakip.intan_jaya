...
<div class="section" style="font-size: 12px;">
    <div class="card">
    <form action="<?= base_url('master/proccesstambahhakakses'); ?>" method="POST" id="tab-content-1">
            ...
            <div class="col-sm-6" style="margin: auto;">
                <div class="card-body">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="nama_hah" id="nama_hah" type="text" class="form-control <?= ($validation->hasError('nama_hah')) ? 'is-invalid' : ''; ?>">
                        <div class="invalid-feedback">
