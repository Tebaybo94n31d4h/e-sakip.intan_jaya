...
<div class="section-header">
    ...
    <div class="section-header-back">
        <form action="<?= base_url('master/jabatans/' . $dataopd['id']); ?>" method="post">
...
<div class="section-body" style="font-size: 12px;">
    <div class="card">
        <form action="<?= base_url('master/proccesstambahjabatans/' . $dataopd['id']); ?>" method="POST" id="tab-content-1">
            ...
            <div class="card-footer text-right">
                ...
                <a href="<?= base_url('master/jabatans/' . $dataopd['id']); ?>" class="ml-1 btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
