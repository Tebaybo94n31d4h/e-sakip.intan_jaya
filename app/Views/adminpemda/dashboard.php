                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                      <?php 
                          ...
                          $builder = $builder->like('opd_hdr_id','3');
                          echo $builder->countAllResults('b');
                      ?>
                  </div>
                </div>
              </div>
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                      <?php 
                          ...
                          $builder = $builder->like('opd_hdr_id','3');
                          echo $builder->countAllResults('j');
                      ?>
                  </div>
                </div>
              </div>
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                      <?php 
                          ...
                          $builder = $builder->like('user_created','adminpemda');
                          echo $builder->countAllResults('p');
                      ?>
                  </div>
                </div>
              </div>
              ...
              <div class="card card-success card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                      <?php 
                          $db      = \Config\Database::connect();
                          $builder = $db->table('satuan','s');
                          $builder = $builder->like('opd_id','3');
                          echo $builder->countAllResults('s');
                      ?>
                  </div>
                </div>
              </div>
